  ...
  const cardData = [
    {
      ...
      desc: "Access a wide variety of courses to enhance your skills.",
    },
    {
      color: "bg-[#DD246E]",
      icon: <FaBookDead size={50} />,
      title: "Expert Tutors",
      desc: "Learn from industry-leading professionals and experts.",
    },
    {
      color: "bg-[#8007E6]",
      icon: <FaBookDead size={50} />,
      title: "Flexible Learning",
      desc: "Study at your own pace with our flexible online courses.",
    },
    {
      color: "bg-[#0CAE74]",
      icon: <FaBookDead size={50} />,
      ...
      <section className='about py-16'>
        <div className='container'>
          <div className='heading text-center py-12'>
            <h1 className='text-3xl font-semibold text-black'>Why Scholercity Stands Out</h1>
        ...
        <div className='right w-2/3 md:w-full md:mt-16'>
          <div className='heading w-4/5 md:w-full'>
            ...
            <span className='text-sm mt-2 block leading-6'>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam officia, reiciendis sapiente adipisci nulla non consequuntur eos repellendus laborum veritatis obcaecati neque est id porro voluptatum.
            </span>
            <ul className='my-5'>
